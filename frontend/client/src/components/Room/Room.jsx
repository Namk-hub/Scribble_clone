  ...
  useEffect(() => {
    ...
    function onConnect() {
      socket.emit("joinRoom", {
        ...
        clientId: myClientId,
        avatar: Number(sessionStorage.getItem("avatar") || 0),
      });
            ...
            <div className="count-section">
              <div className="count-row">
                ...
                <span className="count-text">
                  <strong>{room.players.length}</strong> / {MAX_PLAYERS} players
                  joined
                </span>
              </div>
              <p className="count-sub">
                Game starts when the host clicks Start.
              </p>
            </div>
          </div>
          ...
          <div className="card-bottom">
            <div className="tip-box">
              ...
              <p className="tip-text">
                More players = more fun! Invite your friends and start drawing.
              </p>
            </div>
